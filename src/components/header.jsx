...
const header = (props) => {
    const { showsidebar, inputvalue, setinput, searchinput, setDifferentSection } = useContext(Theme)
    return (
        <>
            <LoadingBar
                color='red'
            ...
            <header className="navbar">
                ...
                <div className="navbar-center">
                    ...
                    <Link to='/searchContainer'>
                        <button className="search-button"><i className="ri-search-line" onClick={() => searchinput(`https://yt-api.p.rapidapi.com/search?query=${inputvalue}` , "search")}></i></button>
                    </Link>
                </div>
